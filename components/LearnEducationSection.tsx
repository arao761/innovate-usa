...
const LearnEducationSection: React.FC = () => {
    return (
        <section id="learn-education" className="py-20 bg-gradient-to-b from-gray-900 to-blue-900">
            <div className="container mx-auto px-6">
                ...
                >
                    <h2 className="text-6xl font-bold text-blue-400 mb-8">Learn and Education</h2>
                ...
                <motion.div 
                    className="bg-gray-800 p-10 rounded-3xl shadow-2xl hover:shadow-blue-400/20 transition-all duration-300 border border-blue-400/20 mb-16"
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.8, delay: 0.2 }}
                >
                    <h3 className="text-3xl font-bold mb-6 text-blue-400">American Enterprise System</h3>
                    <div className="space-y-6">
                        <div>
                            <h4 className="text-2xl font-semibold mb-2 text-gray-200">What is it?</h4>
                        ...
                        <div>
                            <h4 className="text-2xl font-semibold mb-2 text-gray-200">How does it relate to businesses?</h4>
                            <p className="text-gray-300 text-lg">
                ...
                <h3 className="text-4xl font-bold text-blue-400 mb-10 text-center">Five Pillars of the American Enterprise System</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {pillars.map((pillar, index) => (
                        <motion.div
                            key={index}
                            className="bg-gray-800 p-8 rounded-2xl shadow-lg hover:shadow-blue-400/20 transition-all duration-300 border border-blue-400/20 flex flex-col items-center"
                            initial={{ opacity: 0, y: 20 }}
                            animate={{ opacity: 1, y: 0 }}
                            transition={{ delay: index * 0.1, duration: 0.6 }}
                        >
                            <pillar.icon className="text-5xl text-blue-400 mb-4" />
                            <h3 className="text-2xl font-semibold mb-4 text-blue-400 text-center">{pillar.title}</h3>
