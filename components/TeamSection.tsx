...
const teamMembers = [
    ...
    { name: 'Cara King', role: 'Director of Public Affairs', imgSrc: '/image6.jpg', description: 'Leads public relations efforts and manages media outreach.' },
    { name: 'Deryck Toney', role: 'Secretary', imgSrc: '/deryck.jpg', description: 'Handles administrative tasks and keeps track of meetings.' },
