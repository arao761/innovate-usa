...
const teamMembers = [
    ...
    { name: 'Roshini Mantena', role: 'Program Manager', imgSrc: '/images/roshini.jpg', description: 'Manages day-to-day operations, coordinates team efforts.' },
    { name: 'Rashmi Mantena', role: 'Partnership Director', imgSrc: '/images/rashmi.jpg', description: 'Focuses on building strategic partnerships.' },
    ...
    { name: 'Cara King', role: 'Director of Public Affairs', imgSrc: '/images/cara.jpg', description: 'Leads public relations efforts and manages media outreach.' },
